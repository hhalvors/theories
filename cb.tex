...
of a $2$-category, viz.\ the category $\2{Cat}$ of all (small)
categories. Here the interesting features of morphisms (functors) are
not iso, monic, epi, etc., but full, faithful, essentially surjective,
etc. (For a general $2$-category $D$, the corresponding properties of
morphisms have slightly more complicated definitions.)  Similarly, the
...
as ``isomorphism up to isomorphism.'' Hence, if relations between
theories are to be explicated in terms of properties of morphisms
between theories, these explications should make use of
