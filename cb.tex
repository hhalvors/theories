...
\begin{proof} Let $F:T_1\to T_2$ and $G:T_2\to T_1$ be conservative
  ...
  \citep{summer2020}, $F$ is a homotopy equivalence.  \end{proof}

\begin{note} I'm not completely sure yet about the previous
  result. The issue is that Theorem 7.1 is about weak
  translations. \end{note}
