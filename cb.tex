...
conservative, but the faithfulness condition says something more.
...
\begin{proof} Let $X$ be an arbitrary theory, and consider the functor
  $\2{Th}(X,T_1)\to \2{Th}(X,T_2)$ given on objects (translations) by
  $G\mapsto F\circ G$ and on arrows (t-maps) by
  $\chi\mapsto 1_F\ast \chi$. \end{proof}
