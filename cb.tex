...
I think this conjecture follows from the previous proposition, but my
intuition here is that when theories have finitely many non-isomorphic
models (of each fixed cardinality), then categorical equivalence
implies bi-interpretability.
